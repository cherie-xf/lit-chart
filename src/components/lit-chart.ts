...
export default class LitChart extends LitElement {
  ...
  @property({ type: Object, reflect: true }) presetOpt = {} as EChartOption;
  ...
  private updateSeriesLayout(series: Array<Object>, layoutBy: string) {
  ...
  private getChartOption = (type: string): EChartOption => {
    const typeToOption: Record<string, EChartOption> = {
